...
class ElevationGridFile(RasterMapFile):
    ...
    This object inherits the :class:`gsshapyorm.orm.RasterMapFile` base class.
    ...
    def generateFromRaster(self,
        ...
        Example::
            ...
            from gsshapyorm.orm import ProjectFile, ElevationGridFile
            from gsshapyorm.lib import db_tools as dbt


            gssha_directory = '/gsshapyorm/tests/grid_standard/gssha_project'
